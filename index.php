...
<html lang="en">
  ...
  <body>
  	<?php  
  		$con = mysqli_connect('127.0.0.1', 'root','','lesson25');
	 		...
	 		?>	
				...
				<div class="input" style="display: none;">
					<form action="update.php" method="GET">
						<input name="id" class="form-control" value="<?php echo $stroka["id"]?>"></input>
						<input name="text" class="form-control" value="<?php echo $stroka["text"]?>"></input>
						<input name="img" class="form-control" value="<?php echo $stroka["img"]?>"></input>
						<button class="btn2 btn primary">сохранить</button>
					</form>
				</div>
				<button class="btn1 btn btn primary">редактировать</button>
